...
// -----------------------------------------------------------------------------
// Interactive vector wordmark on the hero finder title only (the header/footer
// wordmarks stay static after the hover-glow removal)
// -----------------------------------------------------------------------------
function initVectorWordmarks() {
    ...
    // Per request the hover glow stays ONLY on the hero finder title. The
    // header/footer wordmarks render their static .vector-wordmark-fallback.
